...
namespace Sveit.Droid
{
    ...
    public class CustomNavigationBarRenderer : NavigationPageRenderer
    {
        ...
        {
            _bottomMargin = Convert.ToInt32(context.Resources.DisplayMetrics.Density * 25);
        ...
        protected override void OnLayout(bool changed, int l, int t, int r, int b)
        {
            ...
            var bottomMargin = isTransparent ? 0 : _bottomMargin;
            ...
            int containerHeight = b - t - ContainerPadding - marginTop - bottomMargin; //101 45
